...
<script>
    export default {
        ...
        methods: {
            //新建
            createTemplate(){
                window.location.href="/article/templates/create";
            },
            //编辑
            editTemplate(index, row){
                window.location.href="/article/templates/"+row.id+"/edit";
            },
            //删除
            deleteTemplate(index, row){
                axios.delete('/article/templates/'+row.id)
               .then((response)=> {
           ...
           getPage(page){
               //加载table数据
               page = page || 1
               axios.get('/article/templates?page='+page)
               .then((response)=> {
                   console.log(response)
